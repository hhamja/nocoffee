...
class SevenDayLineChart extends StatelessWidget {
  ...
  const SevenDayLineChart({super.key, required this.coffeModelList});
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime sevenDayAgo = today.subtract(const Duration(days: 6));
    final String formattedToday = DateFormat('yyyy년 M월 d일').format(today);
    final String formattedSevenDayAgo =
        DateFormat('yyyy년 M월 d일').format(sevenDayAgo);
